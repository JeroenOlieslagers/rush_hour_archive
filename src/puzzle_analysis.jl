...
#save("data/processed_data/all_prbs_stat_space_features.jld2", state_space_features)
#save("data/processed_data/new_norm_features.jld2", "data", XX)
X = load("data/processed_data/new_features.jld2")["data"]
state_space_features_all = load("data/processed_data/full_all_prbs_stat_space_features.jld2")
XX = load("data/processed_data/new_norm_features.jld2")["data"]
...
df = DataFrame(CSV.File("data/processed_data/new_17_features.csv"))

#CSV.write("data/processed_data/new_17_features.csv", df)
#df = DataFrame(load("data/processed_data/13_features.jld2"))
...
#save("data/processed_data/exhaustive_linear_BICs.jld2", "data", AICs)
#save("data/processed_data/exhaustive_linear_AICs.jld2", "data", BICs)
#save("data/processed_data/exhaustive_linear_CVs.jld2", "data", CVs)
BICs = load("data/processed_data/exhaustive_linear_BICs.jld2")["data"]
...
jsons = readdir("data/raw_data/problems")[15:end]
